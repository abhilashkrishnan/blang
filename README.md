...
Blaze will be a compiled and interpreted programming language. Blaze will follow the philosophy of Java, **"Write once, run anywhere"** (WORA). Blaze Compiler will generate Blaze Bytecode (Intermediate Language Representation) in Blaze Class file. Blaze VM will execute the Class file containing Bytecode at runtime. Blaze VM will be a Stack based Virtual Machine implementation written in C++ 17 standards.
